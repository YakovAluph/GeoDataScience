  ...
  output$mainTabs <- renderUI({
    ...
    if (!dataReady()) {
      ...
      tabsetPanel(
        ...
        # Note: Cross-Validation tab removed entirely
      )
    }
  })
  ...
  observeEvent(input$plotBtn, {
    ...
    withProgress(message = "Running Analysis...", value = 0.1, {
      ...
      output$variogramPlot <- renderPlot({
        ...
        par(
          font.main = 2, cex.main = 1.8,  # title bold & larger
          font.lab  = 1, cex.lab  = 1.4,  # axis titles plain
          font.axis = 1, cex.axis = 1.2   # tick labels
        )
